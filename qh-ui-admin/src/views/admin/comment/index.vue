<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="评价对象类型" prop="targetType">
        <el-select v-model="queryParams.targetType" placeholder="请选择评价对象类型" clearable>
          <el-option
      ...
      <el-form-item label="评价对象id" prop="targetId">
        <el-input
    ...
    <el-table v-loading="loading" :data="commentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="评价对象类型" align="center" prop="targetType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.user_type" :value="scope.row.targetType"/>
        </template>
      </el-table-column>
      <el-table-column label="评价对象id" align="center" prop="targetId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="操作者id" prop="operatorId">
          <el-input v-model="form.operatorId" placeholder="请输入操作者id" />
        </el-form-item>
        <el-form-item label="评价对象类型" prop="targetType">
          <el-select v-model="form.targetType" placeholder="请选择评价对象类型">
            <el-option
              v-for="dict in dict.type.user_type"
              :key="dict.value"
              :label="dict.label"
        ...
        <el-form-item label="评价对象id" prop="targetId">
          <el-input v-model="form.targetId" placeholder="请输入评价对象id" />
        </el-form-item>
        <el-form-item label="分数" prop="score">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        targetType: [
          { required: true, message: "评价对象类型不能为空", trigger: "change" }
        ],
        targetId: [
          { required: true, message: "评价对象id不能为空", trigger: "blur" }
        ],
      }
    };
  },
